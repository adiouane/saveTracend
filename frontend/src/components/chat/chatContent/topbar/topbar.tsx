  ...
  //TODO: WSALT HNA ADD RESPONSIVE FOR FRIENDS LIST
    ...
    return(
        ...
        <div className="flex flex-col " >
          <div className="lg[1000px]:hidden">
          </div>
          <h3 className=" mb-1 font-extrabold flex items-center">
            <img src="https://cdn0.iconfinder.com/data/icons/small-n-flat/24/678109-profile-group-256.png" alt="" className="mr-2 lg:hidden w-7 h-7 cursor-pointer" 
            onClick={() => {setIsDirectMessagePage(!isDirectMessagePage); }}
            />
